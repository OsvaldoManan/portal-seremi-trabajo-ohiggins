...
(function() {
  ...
  const INDEX = [
    ...
    { titulo: 'Recursos descargables', url: 'actividades.html#tab-recursos', tags: 'recursos descargables plantillas contrato finiquito denuncia carta', tipo: 'Sección' },
    ...
    { titulo: 'Glosario · Términos técnicos', url: 'recursos.html#tab-glosario', tags: 'BIP FNDR RATE PET IMM OMIL AFC AFP SUSESO ENE SII BNE CBC MUSD UTM Karin SENCE SEREMI MIDESO IPS ISL OIT PGU IDLC INE', tipo: 'Sección' },
    { titulo: 'FAQ · Preguntas frecuentes', url: 'recursos.html#tab-faq', tags: 'faq preguntas como cotizar denunciar acoso ley karin salario minimo OMIL cesantia temporera bono trabajo mujer', tipo: 'Sección' },
    { titulo: 'Indicadores · IDLC', url: 'comunas.html#tab-idlc', tags: 'IDLC indice desarrollo laboral comunal ranking sintetico componentes formalizacion', tipo: 'Sección' },
    { titulo: 'Indicadores · Correlaciones', url: 'comunas.html#tab-correlacion', tags: 'correlacion scatter regresion lineal R2 R cuadrado variables', tipo: 'Sección' },
